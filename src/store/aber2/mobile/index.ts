 ...
 */
 ...
 dircom(  )
    ...
    while( a<numobs )
       {
       c=findzone( getItem(a).locationId, b ) ;
       sprintf( d, "%s%d", b, c ) ;
       if( !getItem(a).isLocatedAt ) strcpy( d, "CARRIED" ) ;
       if( getItem(a).isContained ) strcpy( d, "IN ITEM" ) ;
...
errk:t=my_lev ;
 ...
 pepdrop(  )
    ...
    */
    ...
    /*
    if( ( iscarrby( 89, mynum ) )&&( getItem(89).isCarried ) )
       {
       */
    /* Fried dragon */
    /*
