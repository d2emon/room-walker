...
Invis doors*/
 /*
        ...
        newch=getItem(droff).locationId;
        }
     if(newch==-139)
        {
 ...
 /*
  ...
  dogive(ob,pl)
     ...
     if((my_lev<10)&&(ob==32))
      ...
      getItem(ob).setItemIsCarriedBy(pl);
  ...
  stealcom()
     ...
     if(f<e)
        ...
        if(f&1){
             ...
             getItem(a).setIsCarriedBy(mynum);
        return;
        }
     else
        {
...
GOTOSS eek!*/
 ...
 {
         extern long curch;
     if((getItem(186).locationId==curch) && getItem(186).isDestroyed)
     {
 ...
 emptycom()
 {
     ...
     while(b<numobs)
     {
         if(iscontin(b,a))
         {
             getItem(b).setItemIsCarriedBy(mynum);
