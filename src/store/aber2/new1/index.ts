 ...
 break;
  ...
  wavecom()
     ...
     switch(a)
        {
        case 136:
           if((state(151)==1)&&(getItem(151).locationId==curch))
              {
              setstate(150,0);
 ...
 break ;
  ...
  putcom()
     ...
     if(c==192)
     {
         ...
         sendsys("","",-10000,getItem(193).locationId,ar);
         getItem(a).setIsLocatedAt(getItem(193).locationId);
         return;
     }
     ...
     if(a==32)
     {
         ...
         getItem(a).setItemIsContainedIn(c);
     bprintf("Ok.\n");
  ...
  pushcom()
     ...
     switch(x)
        ...
        case 30:
           ...
           if(state(28))
              {
              sendsys("","",-10000,getItem(28).locationId,"\001cThe portcullis falls\n\001");
              sendsys("","",-10000,getItem(29).locationId,"\001cThe portcullis falls\n\001");
              }
           else
              {
              sendsys("","",-10000,getItem(28).locationId,"\001cThe portcullis rises\n\001");
              sendsys("","",-10000,getItem(29).locationId,"\001cThe portcullis rises\n\001");
              }
           break;
        case 149:
           ...
           if(state(150))
              {
              sendsys("","",-10000,getItem(150).locationId,"\001cThe drawbridge rises\n\001");
              sendsys("","",-10000,getItem(151).locationId,"\001cThe drawbridge rises\n\001");
              }
           else
              {
              sendsys("","",-10000,getItem(150).locationId,"\001cThe drawbridge is lowered\n\001");
              sendsys("","",-10000,getItem(151).locationId,"\001cThe drawbridge is lowered\n\001");
              }
           break;
        case 24:
           if(state(26)==1)
...
/*
 ...
 long  ail_deaf=0;
  ...
  destroy(ob)
     {
      getItem(ob).flags[DESTROYED] = true;
     }
 ...
 PLAYER pinit[48]=
  ...
  iswornby(item,chr)
     ...
     if(!getItem(item).isCarriedBy) return(0);
     return(1);
     }
 ...
 on_flee_event()
 {
     ...
     while(ct<numobs)
     {
         ...
         {
             getItem(ct).setIsLocatedAt(ploc(mynum));
         }
         ct++;
     }
 }
